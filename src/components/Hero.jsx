  ...
  const waves = useMemo(
    () => (
      <div className="absolute inset-0 pointer-events-none">
        <div className={`absolute -inset-8 rounded-full blur-3xl transition-opacity ${
  ...
  return (
    <section id="hero" className="relative h-[100svh] w-full overflow-hidden bg-black text-white">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 lg:px-12 py-5">
        ...
        <div className="flex items-center gap-6">
          ...
          <button
            ...
            className={`relative inline-flex items-center gap-2 rounded-full border border-white/10 px-3 py-1.5 text-sm transition ${
      ...
      <div className="relative z-10 h-[calc(100svh-72px)] flex flex-col items-center justify-center text-center px-6">
        {/* Avatar with faint reflection */}
        <div className="relative mb-6">
          <img
            src="/logo.png"
            alt="Profile avatar"
            className="h-24 w-24 rounded-full object-cover ring-2 ring-white/10 shadow-lg shadow-cyan-500/10"
          />
          {/* Reflection */}
